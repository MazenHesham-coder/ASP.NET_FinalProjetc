...
using AspPageWebApplication.Application;
...
namespace AspPageWebApplication
{
    public class Startup
    {
        ...
        {
            // DbContext will be able to see the connection string at the beginning of implementation
            services.AddDbContextPool<UniversityDbContext>(option =>
            option.UseSqlServer(Configuration.GetConnectionString("UniversityDatabase")));

            services.AddScoped<IManageUniversity, ManageUniversity>();
